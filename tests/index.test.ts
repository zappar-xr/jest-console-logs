...
describe("tests", () => {
  it("expectConsoleLogs", async () => {
    ...
    await util.expectSequential({
      ...
      page,
      timeoutMs: 30000,
      ignore: new Set(["[HMR] Waiting for update signal from WDS...", "[WDS] Hot Module Replacement enabled.", "[WDS] Live Reloading enabled."]),
    });
